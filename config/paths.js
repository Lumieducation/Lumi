...
const appIndex = (() => {
    switch (process.env.TARGET) {
        case 'run':
            return resolveModule(resolveApp, 'src/client/apps/run/boot/index');
        case 'main':
        default:
            return resolveModule(
                resolveApp,
                'src/client/apps/editor/boot/index'
            );
    }
})();
...
module.exports = {
    ...
    appIndexJs: resolveModule(resolveApp, 'src/client/boot/index'),

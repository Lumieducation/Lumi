...
export class LumiRunAPI {
    ...
    */
    ...
    /**
    * returns H5P parameters and metadata

    * @method
    * @name LumiRunAPI#geth5p
         * @param {integer} id - H5P id
    */
    geth5p(
        parameters: {
    ...
    ): Promise<ResponseWithBody<200, H5P> | ResponseWithBody<404, Error>> {
        const domain = parameters.$domain ? parameters.$domain : this.domain;
        let path = '/v0/h5p';
        if (parameters.$path) {
            path =

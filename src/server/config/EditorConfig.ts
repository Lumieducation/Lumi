...
export default class EditorConfig {
    ...
    public ajaxPath: string = '/api/v0/h5p/ajax?action=';

    public baseUrl: string = '/api/v0/h5p';
     ...
     */
    public filesPath: string = '/api/v0/h5p/content';
     ...
     * Not user-configurable and should not be changed by custom implementations.
     */
    public h5pVersion: string = `${this.coreApiVersion.major}.${this.coreApiVersion.minor}`;
     ...
     */
    public libraryUrl: string = '/api/v0/h5p/editor/';
     ...
     */
    public platformName: string = 'Lumi H5P Editor';
     ...
     * unsaved content).
     */
    public temporaryFilesPath: string = '/tmp';
     ...
     */
    public uuid: string = '8de62c47-f335-42f6-909d-2d8f4b7fb7f5'; // TODO: revert to''
